...
///Hacer una función que reciba como parámetro todos los arreglos y encuentre el nombre correspondiente
///a un determinado legajo y lo imprima por pantalla. Se debe invocar la función 3.
