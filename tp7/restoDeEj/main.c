...
///4) Funci�n que cargue un archivo de alumnos, verifica si el archivo ya est� creado previamente
...
///5)Funci�n que muestre todos los alumnos del archivo
...
///6) Funci�n que permite agregar un elemento al final del archivo
...
///7) Funci�n que pasa a una pila los n�meros de legajo de los alumnos mayores de edad
...
///8) Dado un archivo de alumnos, hacer una funci�n que cuente la cantidad de alumnos mayores a edad espec�fica que se env�a por par�metro
...
///9) Dado un archivo de alumnos, mostrar por pantalla el nombre de todos los alumnos entre un rango de edades espec�fico (por ejemplo, entre 17 y 25 a�os). Dicho rango debe recibirse por par�metro. Modularizar
...
///11) Crear una funci�n que retorne la cantidad de alumnos que cursan un determinado a�o. El a�o buscado se pasa por par�metro.
...
int main()
{
    ...
    while (opcion != 9){
        ...
        printf("8. Mostar alumnos de un a�o especifico\n");
        printf("9. Salir\n");
