...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Libro más caro: " + libroMasCaro.getTitulo() + " ($" + libroMasCaro.getPrecio() + ")");
        System.out.println("Libro más barato: " + libroMasBarato.getTitulo() + " ($" + libroMasBarato.getPrecio() + ")");
    }
}